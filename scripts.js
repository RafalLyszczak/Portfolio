function changeText1(){
    ...
    newDiv.innerHTML = `
    <p>
        Hi, welcome to my portfolio web project. I would like to give you a quick view on my person.
    </p> 
    <p>
    ...
    <ul>
        ...
        <li>
            Sport is quite a new hobby for me (3 years), as is mobility and building muscles. My favorite part of that is progression.
        </li>
        <li>
            I love preaching food, especially desserts. My meal story started when I was 10. From small meals for myself to making parties for 14 people, traditional food is the key.
        </li>
        <li>
...
function changeText2(){
    ...
    newDiv.innerHTML = `
    <p>
        I obtained my Education in Poland, details below:<br>
    </p>
    <ul>
        <li>
...
function changeText3(){
    ...
    newDiv.innerHTML = `
    <p>
        I do not have professional work experience in codding or other IT departments.<br> My history of employment:
    </p>
    <ul>
        <li>
        ...
        <li>
            Carrer | Self-employed 01/01/2021–01/02/2023: Private care for an elderly lady and her family. This job I got accidentally. My firend eneeded some help, and from time to time I helped her, and she offered me to become her primary caregiver.
        </li>
        <li>
...
function changeText4(){
    ...
    newDiv.innerHTML = `
    <p>
        I started to code in the past, but as a hobby, then took quite a long break. I am definitely into code. Currently, I am working in the hospital as an HCA. I was comparing nursing to coding, and I realized I like coding more than nursing. The main reason is that computers and code are more familiar with my personality.
    </p>
    <h2>
        Goals:
    </h2>
    <ul>
        <li>
            Start career as front end developer (apprenticeship/entry position/inter position)</li><li>Get know code in professional way,
        </li>
        <li>
